...
public class CustomReport implements IReporter{
	...
	private String reportTitle= "FamilyNow Provider Portal Application";
	private String reportFileName = "ProviderPortal-TestRun-Report.html";
	...
	protected void startHtml(PrintWriter out) {
		...
		out.println(".failedodd td,.numi_attn {background-color: #f49b42}");
		out.println(".failedeven td,.stripe .numi_attn {background-color: #f49b42}");
